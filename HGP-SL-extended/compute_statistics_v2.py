...
def parse_arguments():
    ...
    parser.add_argument(
        "-d", "--directory",
        type=str,
        default=os.getcwd()+"/RESULTS_PROTEINS",
        help="Directory to search for files. Defaults to the CWD+RESULTS_PROTEINS."
    )
    parser.add_argument(
        "-k", "--kcorrelation",
        type=int,
...
if __name__ == "__main__":
    ...
    print(f"Searching for files containing '{search_string}' in directory '{directory}'.")
